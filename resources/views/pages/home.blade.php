...
<section class="w-100 bg-white py-5 px-2">
    <div class="container">
        ...
        <div class="d-flex align-items-center flex-wrap gap-2 mt-3 mb-4">
            <button class="btn btn-outline-primary btn-blue text-blue py-3 px-4 fs-55">Sanidad <svg
            ...
            <button class="btn btn-outline-primary btn-blue text-blue py-3 px-4 fs-55">Animales <svg
                    xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                    stroke="#0c4cfa" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"
                    class="lucide lucide-arrow-right-icon lucide-arrow-right ms-1">
                    <path d="M5 12h14" />
            ...
            <button class="btn btn-outline-primary btn-blue text-blue py-3 px-4 fs-55">Medio Ambiente <svg
                    xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                    stroke="#0c4cfa" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"
                    class="lucide lucide-arrow-right-icon lucide-arrow-right ms-1">
                    <path d="M5 12h14" />
            ...
            <button class="btn btn-outline-primary btn-blue text-blue py-3 px-4 fs-55">Educacion <svg
                    xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                    stroke="#0c4cfa" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"
                    class="lucide lucide-arrow-right-icon lucide-arrow-right ms-1">
                    <path d="M5 12h14" />
            ...
            <button class="btn btn-outline-primary btn-blue text-blue py-3 px-4 fs-55">Justicia Economica <svg
                    xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                    stroke="#0c4cfa" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"
                    class="lucide lucide-arrow-right-icon lucide-arrow-right ms-1">
                    <path d="M5 12h14" />
        ...
        <div class="row gy-4">
            <div class="col-12 col-md-3">
                <div class="card l-card shadow-sm position-relative">
                    <img src="https://assets.change.org/photos/9/ca/rm/JACarMOCmNQsrUQ-1600x900-noPad.jpg?1653998328"
                         class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title fw-bold">Mi hija se suicido con 15 años. El bullying NO escosa de
                            niñ@s > ¡LEY
                            ACOSO...</h5>
                        <a href="#"
                           class="text-decoration-none d-flex align-items-center gap-2 text-dark-blue fw-bold mt-4">
                            ...
                            </svg>260.571 firmas</a>
                    </div>
                    <div class="arrow-pill rounded-pill d-flex align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                             fill="none" stroke="#f0f0f0" stroke-width="2.25" stroke-linecap="round"
            ...
            <div class="col-12 col-md-3">
                <div class="card l-card shadow-sm position-relative">
                    <img src="https://assets.change.org/photos/8/eh/jj/XZehjjclUZeHmQa-1600x900-noPad.jpg?1759927897"
                         class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title fw-bold">El asesino de mi hijo tenia 17 años. Pido revisar YA la ley
                            del menor para casos graves</h5>
                        <a href="#"
                           class="text-decoration-none d-flex align-items-center gap-2 text-dark-blue fw-bold mt-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                 fill="none" stroke="#0c4cfa" stroke-width="2.25" stroke-linecap="round"
            ...
            <div class="col-12 col-md-3">
                <div class="card l-card shadow-sm position-relative">
                    <img src="https://assets.change.org/photos/9/nn/si/ArnnsibjtqWOsuJ-1600x900-noPad.jpg?1758190571"
                         class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title fw-bold">Me han echado de clase por llevar Hiyab. ¡Libertad religiosa
                            YA en instituo IES...</h5>
                        <a href="#"
                           class="text-decoration-none d-flex align-items-center gap-2 text-dark-blue fw-bold mt-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                 fill="none" stroke="#0c4cfa" stroke-width="2.25" stroke-linecap="round"
            ...
            <div class="col-12 col-md-3">
                <div class="card l-card shadow-sm position-relative">
                    <img src="https://assets.change.org/photos/6/zy/tu/XvzyTUYFsYcnqzV-1600x900-noPad.jpg?1758742974"
                         class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title fw-bold">Soy victima de violencia machista. Pido mejorar urgentemente
                            las pulseras d...</h5>
                        <a href="#"
                           class="text-decoration-none d-flex align-items-center gap-2 text-dark-blue fw-bold mt-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
