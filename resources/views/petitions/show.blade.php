...
@section('content')
    ...
    <div class="container px-md-5 px-3 mt-4">
        ...
        <div class="row w-100 mt-5 gx-4">
            <div class="col-md-8">
                <img class="w-100 petition-img" src={{ asset('petitions/' . $petition->file->name) }} alt="">
                    ...
                    <article class="border mt-3 border-1 border-gray rounded-3 d-flex flex-column p-3">
                        ...
                        <div class="d-flex align-items-center gap-4 mt-3">
                            <div class="d-flex align-items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" width="18"
                                    height="18" viewBox="0 0 24 24" fill="none" stroke="#3d3d3d" stroke-width="1.5"
            ...
            <div class="col-md-4">
                <div class="shadow d-flex flex-column p-4 rounded-2 w-100">
                    ...
                    <button class="bg-transparent border-0 fw-normal fs-7 p-0 mt-1" type=" button" data-bs-toggle="collapse"
                    ...
                    <?php    if (!$hasSigned) { ?>
                    <form action="{{route("petition.sign", ['id' => $petition->id])}}" method="get">
                    ...
                    <?php    } else { ?>
                    <p>Ya has firmado esta peticion!</p>
                    <?php    } ?>
                    <?php } else { ?>
                    <p>Debes iniciar sesion para poder firmar esta peticion</p>
                    <?php } ?>
                </div>
            </div>
        </div>
